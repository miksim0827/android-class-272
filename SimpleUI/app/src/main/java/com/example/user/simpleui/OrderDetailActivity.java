...
//        String address = order.getStoreInfo().split(",")[1];          //作業用
        String resultText = "";
        ...
        MapFragment fragment = (MapFragment)getFragmentManager().findFragmentById(R.id.mapFragment);     //找地圖
    ...
    public void done(double[] latlng) {
        if(latlng != null)
        {
            ...
            CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(latLng, 17);  //放大圖17倍
